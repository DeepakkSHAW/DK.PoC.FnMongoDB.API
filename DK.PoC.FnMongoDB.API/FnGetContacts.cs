...
namespace DK.PoC.FnMongoDB.API
{
    public class FnGetContacts
    {
        ...
        [Function("ContactV3")]
        public async Task<HttpResponseData> ContactV3([HttpTrigger(AuthorizationLevel.Anonymous,
            "get", Route = "v3/contact/{id}")] HttpRequestData req, string id)
        {
        ...
        [Function("ContactsV3")]
        public async Task<HttpResponseData> ContactsV3([HttpTrigger(AuthorizationLevel.Anonymous,
            "get", Route = "v3/contact")] HttpRequestData req)
        {
            var response = req.CreateResponse();
            try
            {
        ...
        [Function("AddContactV3")]
        public async Task<HttpResponseData> AddContactV3([HttpTrigger(AuthorizationLevel.Anonymous,
            "post", Route = "v3/contact")] HttpRequestData req)
        {
            var response = req.CreateResponse();
            try
            {
        ...
        [Function("UpdateContactV3")]
        public async Task<HttpResponseData> UpdateContactV3([HttpTrigger(AuthorizationLevel.Anonymous,
            "put", Route = "v3/contact/{id}")] HttpRequestData req, string id)
        {
            var response = req.CreateResponse();
            try
            {
        ...
        [Function("RemoveContactV3")]
        public async Task<HttpResponseData> RemoveContactV3([HttpTrigger(AuthorizationLevel.Anonymous,
            "delete", Route = "v3/contact/{id}")] HttpRequestData req, string id)
        {
            var response = req.CreateResponse();
            try
            {
